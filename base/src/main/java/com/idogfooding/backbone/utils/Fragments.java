...
public final class Fragments {
     ...
     */
    @CheckResult
    public static SingleOperator checkout(FragmentActivity activity,
                                          Fragment fragment) {
     ...
     */
    @CheckResult
    public static SingleChildOperator checkout(Fragment hostFragment,
    ...
    public static final class SingleChildOperator {
        ...
        private SingleChildOperator(@NonNull Fragment hostFragment, String tag) {
            ...
            for (Fragment tagFragment : fragments) {
                if (StrKit.equals(tagFragment.getTag(), tag)) {
        ...
        public boolean into(@IdRes int containerId) {
            ...
            for (Fragment oldFragment : fragments) {
                ...
                if (StrKit.equals(oldFragment.getTag(), tag)) {
                    if (!disableReuse) {
