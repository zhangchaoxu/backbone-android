 ...
 * SplashView
 *
 * see {https://github.com/jkyeo/Android-SplashView}
 *
 * @author jkyeo
 * @author Charles
 */
...
public class SplashView extends FrameLayout {
    ...
    void initComponents() {
        ...
        skipButton.setOnClickListener(v -> dismissSplashView(true));
    ...
    private void setOnSplashImageClickListener(@Nullable final OnSplashViewActionListener listener) {
        ...
        splashImageView.setOnClickListener(v -> listener.onSplashImageClick(actUrl));
    }
    ...
    private static void getAndSaveNetWorkBitmap(final String urlString) {
        Runnable getAndSaveImageRunnable = () -> {
            URL imgUrl1 = null;
            Bitmap bitmap = null;
            try {
                imgUrl1 = new URL(urlString);
                HttpURLConnection urlConn = (HttpURLConnection) imgUrl1.openConnection();
